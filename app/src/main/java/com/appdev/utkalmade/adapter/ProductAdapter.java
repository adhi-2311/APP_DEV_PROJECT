package com.appdev.utkalmade.adapter;
...
import com.appdev.utkalmade.Productdetails;
import com.appdev.utkalmade.R;
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
                public void onClick(View view) {
                    ...
                    i.putExtra("image",productsList.get(position).getBigImageUrl());
                    i.putExtra("desc", productsList.get(position).getProductDesc());
    /*
